<section class="panel">
	<div class="tabs-custom">
		...
		<div class="tab-content">
			<div class="tab-pane box active mb-md" id="complaint">
				<div class="row">
<?php if (get_permission('config_reception', 'is_add')): ?>
					<div class="col-md-5 pr-xs">
						<section class="panel panel-custom">
							<div class="panel-heading panel-heading-custom">
								<h4 class="panel-title"><i class="far fa-edit"></i> <?=translate('complaint') . " " . translate('type') . " " . translate('visiting_purpose')?></h4>
							</div>
					...
					<div class="col-md-<?php if (get_permission('config_reception', 'is_add')){ echo "7 pl-xs"; }else{ echo "12"; } ?>">
						<section class="panel panel-custom">
							<header class="panel-heading panel-heading-custom">
								<h4 class="panel-title"><i class="fas fa-list-ul"></i> <?=translate('complaint') . " " . translate('type') . " " . translate('list')?></h4>
							</header>
							<div class="panel-body panel-body-custom">
										...
										<tbody>
											...
											<?php endif; ?>
												...
												<?php endif; if (get_permission('config_reception', 'is_delete')): ?>
													<!--delete link-->
													<?php echo btn_delete('reception_config/delete/complaint_type/' . $row['id']);?>
												<?php endif; ?>
												</td>
											</tr>
										<?php
	...
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title">
				<i class="far fa-edit"></i> <?php echo translate('edit') . " " . translate('complaint') . " " . translate('type'); ?>
			</h4>
		</header>
		<?php echo form_open('reception_config/edit/complaint_type', array('class' => 'frm-submit')); ?>
