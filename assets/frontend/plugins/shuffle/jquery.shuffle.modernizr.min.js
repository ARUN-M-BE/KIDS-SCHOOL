...
window.Modernizr = function(a, b, c) {
        ...
        function i(a, b, c) { var d = a.charAt(0).toUpperCase() + a.slice(1),
            ...
            A = function(a, c, d, e) { var f, g, h, i, j = b.createElement("div"),
                    ...
                    for (; d--;) h = b.createElement("div"), h.id = e ? e[d] : q + (d + 1), j.appendChild(h); return f = ["&faq73;", '<style id="s', q, '">', a, "</style>"].join(""), j.id = q, (k ? j : l).innerHTML += f, l.appendChild(j), k || (l.style.background = "", l.style.overflow = "hidden", i = p.style.overflow, p.style.overflow = "hidden", p.appendChild(l)), g = c(j, a), k ? j.parentNode.removeChild(j) : (l.parentNode.removeChild(l), p.style.overflow = i), !!g },
            B = {}.hasOwnProperty;
    ...
    function(a) { "function" == typeof define && define.amd ? define(["jquery", "modernizr"], a) : window.Shuffle = a(window.jQuery, window.Modernizr) }(function(a, b, c) { "use strict";
