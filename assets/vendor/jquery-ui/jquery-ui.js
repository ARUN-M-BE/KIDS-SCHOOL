...
(function(factory) {
    ...
    $.Widget.prototype = {
        ...
        _off: function(element, eventName) {
            ...
            // Clear the stack to avoid memory leaks (faq0056)
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseUp: function(event) {
            ...
            // Only need to focus if the event occurred on the draggable itself, see faq0527
            ...
            $.each(draggable.sortables, function() {
                ...
                if (innermostIntersecting) {
                    ...
                    if (sortable.isOver) {
                        ...
                        // may have modified them in unexpected ways. (#8809, faq0669)
